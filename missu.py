...
# Thêm nhãn (Label)
label = tk.Label(root, text="T có điều muốn nói với bạn!", font=("Arial", 18, "bold"), bg="pink")
label.pack(pady=20)  
...
def open_new_window():
    ...
    new_label = tk.Label(new_window, text="Tớ xin lỗi đã làm bạn giận!", font=("Arial", 14, "bold"), bg="pink")
